...
In the past few decades, church leaders, including some Apostles, have made statements that suggest Eve was informed.
...
The deception of Eve is a fixed point in the standard works, supported by Hebrew etymology and cross-scriptural commentary. No canonical ambiguity exists to support the "informed-Eve" hypothesis. This modern reinterpretation relies on cultural presentism rather than scriptural or logical data. Deviating from the literal deception narrative fundamentally alters the doctrine of the Fall and sets a dangerous precedent where well-supported Christian doctrines can be rewritten based on changing cultural views.
